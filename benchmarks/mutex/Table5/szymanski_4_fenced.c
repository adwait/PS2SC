...
assume(__flag1< 3 && __flag2< 3 && __flag3< 3);
...
rlx_read_ps(flag2, __flag2);
rlx_read_ps(flag3, __flag3);
if(__flag1==1 || __flag2==1 || __flag3==1){
...
rlx_read_ps(flag2, __flag2);
rlx_read_ps(flag3, __flag3);
	assume(__flag1==4 || __flag2==4 || __flag3==4);
}
...
rlx_read_ps(flag2, __flag2);
rlx_read_ps(flag3, __flag3);
assume(__flag1 != 2 && __flag1!= 3 && __flag2 != 2 && __flag2!= 3 && __flag3 != 2 && __flag3!= 3);
...
rlx_read_ps(flag2, __flag2);
rlx_read_ps(flag3, __flag3);
assume(__flag0< 3 && __flag2< 3 && __flag3< 3);
...
rlx_read_ps(flag2, __flag2);
rlx_read_ps(flag3, __flag3);
if(__flag0==1 || __flag2==1 || __flag3==1){
...
rlx_read_ps(flag2, __flag2);
rlx_read_ps(flag3, __flag3);
	assume(__flag0==4 || __flag2==4 || __flag3==4);
}
...
rlx_read_ps(flag2, __flag2);
rlx_read_ps(flag3, __flag3);
assume(__flag2 != 2 && __flag2!= 3 && __flag3 != 2 && __flag3!= 3);
...
rlx_read_ps(flag1, __flag1);
rlx_read_ps(flag3, __flag3);
assume(__flag0< 3 && __flag1< 3 && __flag3< 3);
rlx_write_ps(flag2, 3);

rlx_read_ps(flag0, __flag0);
rlx_read_ps(flag1, __flag1);
rlx_read_ps(flag3, __flag3);
if(__flag0==1 || __flag1==1 || __flag3==1){
...
rlx_read_ps(flag1, __flag1);
rlx_read_ps(flag3, __flag3);
	assume(__flag0==4 || __flag1==4 || __flag3==4);
}
...
rlx_read_ps(flag1, __flag1);
rlx_read_ps(flag2, __flag2);
assume(__flag0< 3 && __flag1< 3 && __flag2< 3);
...
rlx_read_ps(flag1, __flag1);
rlx_read_ps(flag2, __flag2);
if(__flag0==1 || __flag1==1 || __flag2==1){
...
rlx_read_ps(flag1, __flag1);
rlx_read_ps(flag2, __flag2);
	assume(__flag0==4 || __flag1==4 || __flag2==4);
}
