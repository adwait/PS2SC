...
void *writer8(void *arg) {
  rlx_write_ps(x, 8);
  return NULL;
}

void *writer9(void *arg) {
  rlx_write_ps(x, 9);
  return NULL;
}

void *writer10(void *arg) {
  rlx_write_ps(x, 10);
  return NULL;
}
...
int main()
{
	...
	pthread_create(&t8, NULL,  writer8, NULL);
	pthread_create(&t9, NULL,  writer9, NULL);
	pthread_create(&t10, NULL,  writer10, NULL);
