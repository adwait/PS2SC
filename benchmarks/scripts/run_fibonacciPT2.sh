...
cd fibonacci_promiseT2
echo $(date) > results.txt
echo >> results.txt
echo $(date) > err.txt
echo "------- RESULTS -------" >> results.txt

run_individual _cs_promised_fibonacci_2.c 3600
run_individual _cs_promised_fibonacci_3.c 3600
run_individual _cs_promised_fibonacci_4.c 3600
