...
__cs_create(&__cs_local_main_thr2, 0, t2_0, 0);
__cs_create(&__cs_local_main_thr3, 0, t3_0, 0);
__cs_create(&__cs_local_main_thr0, 0, t0_0, 0);
__cs_create(&__cs_local_main_thr1, 0, t1_0, 0);
goto __exit_main;
__exit_main:
                ;
__cs_exit(0);
