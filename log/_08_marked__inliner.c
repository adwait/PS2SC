...
# 164 "<previous_module>"
static int _n; _n = __CSEQ_nondet_int();
...
# 178 "<previous_module>"
static int __lv; __lv = __CSEQ_nondet_int();
...
# 185 "<previous_module>"
static int _x; _x = __CSEQ_nondet_int();
    
# 186 "<previous_module>"
static int _y; _y = __CSEQ_nondet_int();
