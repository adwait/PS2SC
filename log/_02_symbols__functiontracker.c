...
Variables:
   (global)
      ...
      id3  'fib1'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[171, 187, 190, 191, 194, 201, 205, 218]'  
      id4  'fib2'  
         type 'int'  kind 'g'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[188, 192, 202, 204, 206, 208, 219]'  
   t0
      id5  '__cs_unused'  
   ...
   t2
      ...
      id11  '_x'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[187, 189, 191, 193]'  
      id12  '_y'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[188, 189, 192, 193]'  
      id13  '_s'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
   ...
   t3
      ...
      id15  '_x'  
         ...
         ref '[]'  
         deref '[]'  
         occurs '[201, 203, 205, 207]'  
      id16  '_y'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
         deref '[]'  
         occurs '[202, 203, 206, 207]'  
      id17  '_s'  
         type 'int'  kind 'l'  arity '0'  
         size '[]'  
         ref '[]'  
